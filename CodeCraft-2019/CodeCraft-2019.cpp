...
// 	  for( which_car=min_car_id;which_car<=min_car_id;which_car++)
// 	  {
...
/*********************************A-Star算法*********************************/ 
     ...
     {
       if( Astar_search(car[i].set,car[i].goal, road,min_road_id,max_road_id,cross,min_cross_id,max_cross_id))
       has_find++;
     }
