...
{  
  ...
  way_cost = 0 * abs(car_->max_speed-map_[cur_cross_sub][down_cross_sub].limit_speed) 
...
{  
    ...
    way_cost = 0 * abs(car_->max_speed-map_[cur_cross_sub][up_cross_sub].limit_speed) 
...
if((right_cross_sub!=-1)&&(map_[cur_cross_sub][right_cross_sub].id!=-1))
{
    ...
    way_cost = 0 * abs(car_->max_speed-map_[cur_cross_sub][right_cross_sub].limit_speed) 
...
{
    way_cost = 0 * abs(car_->max_speed-map_[cur_cross_sub][left_cross_sub].limit_speed) 
